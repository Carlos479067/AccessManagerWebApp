        ...
        <header id={"header"}>
            <div id={"headerContent"}>
                ...
                {loggedInUser ? loggedInUser.authorizedEin === '04516108' ?
                    <div style={{alignText: "Center"}}><h3 id={"welcomeText"} style={{margin: "25px"}}>Welcome {loggedInUser.firstName}</h3><h3 style={{color: "#0A3161", textAlign: "Center"}}>Im an Idiot</h3></div> :
